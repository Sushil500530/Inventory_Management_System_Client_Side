...
const ProductShop = () => {
    ...
    return (
        <div>
            <h3 className="text-3xl text-center font-bold  flex items-center justify-center gap-2 my-12">All Products : <span className="text-fuchsia-500">{allProducts?.length}</span></h3>
